...
namespace PrintingApplication.Domain.Models.User
{
    ...
    public class UserModel : IUserModel
    {
        ...
        [StringLength(50, MinimumLength = 3, ErrorMessage = "Login ID harus diantara 3 sampai 50 karakter !!!")]
        ...
        [StringLength(255, MinimumLength = 2, ErrorMessage = "Password minimal 2 karakter !!!")]
