...
namespace PrintingApplication.Infrastructure.DataAccess.Repositories.Orderan
{
    ...
    internal class OrderanDetailRepository : BaseRepository<IOrderanDetailModel>, IOrderanDetailRepository
    {
        ...
        {
            var queryStr = "INSERT INTO orderan_detail (orderan_id, kode_jenis_orderan, " +
                           "nama_jenis_orderan, lebar, tinggi, total_dimensi, harga_satuan, jumlah, design) " +
                           "VALUES (@orderan_id, @kode_jenis_orderan, @nama_jenis_orderan, @lebar, @tinggi, " +
                           "@total_dimensi, @harga_satuan, @jumlah, @design)";
